	...
	<div style="margin-top: 100px;">
		...
		<div v-else style="margin: 0 auto;width: 900px;">
			...
			<el-row style="margin: 0 auto;padding-top: 50px;padding-bottom: 80px;">
				...
				<el-card :body-style="{ padding: '11px' }" v-for="goods_list in goods_list" :key="goods_list.gid"
					shadow="hover" style="cursor: pointer;margin-bottom: 30px;border-radius: 15px;"
					@click.native="goods_details(goods_list.gid)">
					<div style="display: flex;">
						<el-image v-if="goods_list.gphoto" :src="goods_list.gphoto"
							style="width: 17%;border-radius: 7px;">
							<div slot="error">
