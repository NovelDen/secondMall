							...
							this.request.get("/student/login", {
								...
								if (res.code == '200') {
									...
									setTimeout(() => {
										...
										{
											if (this.goods_list.gstatus == '0' || this.goods_list.gstatus == '1' || this.goods_list.gstatus == '3') {
											...
											} else if (this.goods_list.gstatus == '2') {
												...
												res => {
													if (res.code == '200') {
														...
														if (this.goods_list.gstatus == '0' || this.goods_list.gstatus == '1' || this.goods_list.gstatus == '3') {
															...
															this.request.put("/goods/updateStudentGoods", this.form).then(res => {
																console.log(res);
																if (res.code == '200') {
																	if (this.form.gstatus == '3'
																	) {
